...
},
{
	...
	'description' : 'The biggest city in Vietnam with many high rises. We took day trips from here to see the Cu Chi tunnels from the American War and the historical Cao Dai church.',
...
markers5.forEach(function(item, index){
		let marker = L.marker([item.lat,item.lon]).bindPopup(item.title + ": " + item.description).openPopup();
...
// makes it show all the marrkers
